...
def employer(employer_id):
    ...
    reviews = execute_sql('SELECT review, rating, title, date, status FROM review JOIN employer ON employer.id = review.employer_id = employer.id WHERE employer.id = ?', [employer_id])
